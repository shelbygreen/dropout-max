  ...
  return (
    <section style={pageSection}>
      ...
      <div style={column}>
        ...
        <p style={body}>
          We invite members of the public to sign the open letter and post their stories about Max to the <a href="/notes">"wall"</a>. The more stories we share, the more pressure we put on Max and his enablers to address the issue of sexual assault and complacency towards abuse in Tallahassee. We are not affiliated with any campaign, party, or political committee. We are just some women who believe
          in accountability and the sanctity of public office.
        </p>
        <p style={body}>
          Out of fear of retaliation, we signed the letter with our initials.  Visit the <a href="/records">records page</a> to view first- and second-hand accounts of Max's exploitative actions. We received consent to post those screenshots.
        </p>
        <p style={body}>
